...
$sql_id_local = $con->prepare("SELECT  l.* FROM pedidos p JOIN locales l ON p.id_local = l.id_local  WHERE id_pedido = :id_pedido;");
$sql_id_local->bindParam(':id_pedido', $id_pedido, PDO::PARAM_INT);
$sql_id_local->execute();
$id_local = $sql_id_local->fetch(PDO::FETCH_ASSOC);
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="2"></td>
                                <td colspan="2"><strong>$<?php echo number_format(($total + ($info_pedido ? $info_pedido["costo_envio"] : 0)) - $monto_seña, 2); ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
