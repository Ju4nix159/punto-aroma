    ...
    <main class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                ...
                <p class="lead mb-4">Tu pedido ha sido procesado exitosamente. Hemos enviado un correo electrónico con los detalles de tu compra.</p>
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Fecha estimada de envio del pedido: <strong>7 dias habiles</strong></p>
